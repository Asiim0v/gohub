...
func getEncoder() zapcore.Encoder {
	...
	encoderConfig := zapcore.EncoderConfig{
		...
		LevelKey:       "level",
		NameKey:        "logger",
		CallerKey:      "caller", // 代码调用, 如 paginator/paginator.go
		...
		EncodeCaller:   zapcore.ShortCallerEncoder,     // Caller 短格式, 如: types/converter.go, 长格式为绝对路径
	}
...
// Dump 调用专用, 不会中断程序, 会在终端打印出 warning 消息
...
// DebugJSON 记录一条 JSON 类型的 debug 日志
